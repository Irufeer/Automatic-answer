...
def answer(BookID):
    ...
    book_url = main_url + '/book/index.php?BID=25&CID=' + CID[0][0] + CID[0][1] + CID[0][2] + CID[0][3] + '&Quiz=N'
...
if __name__ == "__main__":
    ...
    # print '视听说教程1()  视听说教程2()  视听说教程3(41)  视听说教程4()'
    # print '听说教程1()  听说教程2()  听说教程3(25)  听说教程4()'
